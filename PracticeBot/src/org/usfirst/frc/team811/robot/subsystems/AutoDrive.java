...
public class AutoDrive extends Subsystem implements Config, PIDOutput {
	private double[] cenX;
	...
	private PIDController turnController = RobotMap.turnController; // RobotMap.turnController;
